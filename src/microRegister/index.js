...
const { MICRO_BIBP_VWEB, MICRO_EMBP_VWEB } = config
...
const microAppConfig = [
  {
    ...
    activeRule: '/module/microChild', // 触发匹配微应用的路由规则
    props: { // 提供给子应用的数据
      routerBase: "/module/microChild", // 子应用路由的base
      getGlobalState: "", // 提供子应用获取公共数据
      routerList: [], // 提供给子应用的路由列表
    }
  },
  {
    name: 'microEmbpVweb', // 唯一性，可用微应用的名称
    entry: MICRO_EMBP_VWEB, // 
    container: '#microContainer', // 微应用挂在的dom
    activeRule: '/microEmbpVweb', // 触发匹配微应用的路由规则
  }
];
